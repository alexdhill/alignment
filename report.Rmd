...
---
```{r, setup, include=F}
knitr::opts_knit$set(root.dir="~/Documents/usc/S2/CSCI570/Project/datapoints")
library(knitr)
library(kableExtra)
library(ggplot2)
library(reshape2)
...
# Contributions
This was an individual project, completed entirely by Alex Hill (Duval Hill on DEN)